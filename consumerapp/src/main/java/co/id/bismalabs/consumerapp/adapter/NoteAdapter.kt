package co.id.bismalabs.consumerapp.adapter
...
import co.id.bismalabs.consumerapp.CustomOnItemClickListener
import co.id.bismalabs.consumerapp.NoteAddUpdateActivity
import co.id.bismalabs.consumerapp.R
