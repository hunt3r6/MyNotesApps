package co.id.bismalabs.mynotesapp.provider
...
import co.id.bismalabs.mynotesapp.db.DatabaseContract.AUTHORITY
import co.id.bismalabs.mynotesapp.db.DatabaseContract.NoteColumns.Companion.CONTENT_URI
import co.id.bismalabs.mynotesapp.db.DatabaseContract.NoteColumns.Companion.TABLE_NAME
import co.id.bismalabs.mynotesapp.db.NoteHelper
