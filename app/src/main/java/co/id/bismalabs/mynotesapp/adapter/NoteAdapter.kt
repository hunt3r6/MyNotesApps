package co.id.bismalabs.mynotesapp.adapter
...
import co.id.bismalabs.mynotesapp.CustomOnItemClickListener
import co.id.bismalabs.mynotesapp.NoteAddUpdateActivity
import co.id.bismalabs.mynotesapp.R
